...
\hline
\textbf{Benchmark} & \textbf{Subject} & \multicolumn{2}{|c|}{\textbf{Analysis Time}} & \multicolumn{2}{|c|}{\textbf{Proof}} & \textbf{\#Inst} & \textbf{\#Path} \\
& & \textbf{\base} & \textbf{\proofopt} & \textbf{Time} & \textbf{Size} & & \\
\hline
