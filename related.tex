...
Keuchel et al.~\cite{icfp22:keuchel} built a prototype \SE engine for a subset of SAIL~\cite{sail},
% say more about the logical framework
% was not demonstrated on real-world use cases
but it does not model core memory features (\eg pointers and dynamic allocations) required by real-world programming languages.
