...
Loom has not demonstrated on a real-world programming language with full memory support (\eg LLVM IR).
To the best of our knowledge,
deriving a foundational program verifier for such programming languages requires non-trivial changes to its underlying theoretical foundations.
