...
However,
their \SE engine has limitations (\eg, no support for recursion) and has not been evaluated on real-world programming languages.
To obtain theoretical results regarding \llvm IR using their framework,
one would need to modify their underlying IR language (and core theory), and mechanize the memory model of \llvm IR,
...
but they remain unverified and do not produce machine-checked proofs.
