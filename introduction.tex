...
Moreover, \SE tools use various optimizations for memory modeling, which complicates the proof generation process.
...
we develop an additional theory that help to interact with various parts of our formalization.
