...
For example, \klee~\cite{klee} uses multiple representations for memory objects, SMT encoding optimizations, \etc
...
% TODO: mechanized concrete semantics?
...
\item Mechanized symbolic semantics for a subset of \llvm with memory.
