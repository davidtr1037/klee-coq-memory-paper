...
The safety property $\safeet$ for execution trees is defined inductively below.\footnote{
The notation $\infeasible(s)$ denotes that the path constraints of $s$ are unsatisfiable.
}
\begin{definition}
\label{def:safe-et}
Let $s$ be a symbolic state and $l$ a list of execution trees, then:
\[
\begin{array}{c}
\ruledef{Step}
{
