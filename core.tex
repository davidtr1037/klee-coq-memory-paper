...
\si{fill in}
We do make some simplifying assumption ... (also backed up by LLVM ref).

\begin{itemize}
  \item operand types in load/store/gep
  \item gep index of struct type is constant in range
  \item malloc ??
\end{itemize}
