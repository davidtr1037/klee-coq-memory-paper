...
We extend both the concrete and symbolic semantics to incorporate a memory model of \llvm and to support memory-related instructions.
Then, we extend the proof of the supporting theory accordingly.
Indeed, extending the supporting theory proved to arduous:
...
The memories $\symmemory_1$ and $\symmemory_2$ are equivalent, denoted by $\symmemory_1 \equiv \symmemory_2$,
if their elements are pointwise equivalent.
