...
% TODO:
In this section,
we establish the connection between the concrete and symbolic semantics.
...
Ultimately, this correspondence helps proving the main theorem of~\Cref{sec:program-safety} (\Cref{theorem:safety-via-et}).

To establish this connection,
we first define the relation between concrete and symbolic states.
