...
we present the symbolic semantics, ...
...
The following theorem states that if the execution tree of the whole program satisfies the safety property described above,
