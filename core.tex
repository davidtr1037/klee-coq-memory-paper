...
An execution tree is a data structure that records the paths that were explored during the analysis of the given program.
Its formal definition can be found in Section 3.4 in~\cite{klee-rocq}.
Following the approach from~\cite{klee-rocq},
we show how certain properties of execution trees can be used to prove program safety.
To handle memory-related instructions,
...
The rule makes sure that there are no error states in the tree, and furthermore,
