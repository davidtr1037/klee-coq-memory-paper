...
\begin{enumerate}
    ...
    \end{enumerate}
\item $\instrat{\location} = \textup{$\codequote{x \ \texttt{=} \ \tcall^{\pointertypeof{\bvsort{8}}} \ \intrinsicfunc{malloc}(\bvsort{64} \ e)}$}$, and \textup{$\evalexprty{e}{\localstore}{\bvsort{64}} > max\_signed_{\indextype}$}.
