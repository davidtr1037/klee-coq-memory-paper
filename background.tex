...
The $\tgep$ instruction computes the address of a subelement of an aggregate data structure (array, struct, \etc.).\footnote{A pseudo-code is given in~\Cref{appendix:concrete-semantics}.}
