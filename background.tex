...
}
{
  \progstate{\location}{\localstore}{\stack}{\memory}
  \step
  \progstate{\nextinstr{\location}}{\localstore}{\stack}{\heapWrite{\memory}{\mo}{p}{\tau}{v}}
}
\\[1em]
\ruledefsmall{GEP}{
...
\heapReplace{\memory}{\mo}{\mo'} & \mbox{replace memory object $\mo$ with $mo'$ ($\scriptstyle \memory\setminus\{\mo\}\cup\{\mo'\}$)}
\end{array}
$}
\end{array}
\]
