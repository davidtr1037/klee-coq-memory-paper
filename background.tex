...
}
{
  ...
  \step
  \progstate{\nextinstr{\location}}{\localstore[x\mapsto \evalexprty{e}\sigma\tau]}{\stack}
}
\\[1em]
...
}
{
  \progstate{\location}{\localstore}{\stack}
  \step
  \progstate{\location\triangleright b_1}{\localstore}{\stack}
}
\\[1em]
\ruledefsmall{Branch-True}{
  \instrat{\location} = \codequote{\tbr~e~b_1~b_2} \quad
...
}
{
  \progstate{\location}{\localstore}{\stack}
  \step
  \progstate{\location\triangleright b_2}{\localstore}{\stack}
}
\\[1em]
...
}
{
  \progstate{\location}{\localstore}{\stack}
  \step
  \progstate{\nextinstr{\location}}{\localstore[x \mapsto n@\bvsort{32}]}{\stack}
}
\\[1em]
\ruledefsmall{Assume}{
