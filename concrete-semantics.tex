...
The semantics of the $\tgep$ instruction is given in~\Cref{alg:gep}.\footnote{
...
\Function{compute-offset}{$\tau, o, \overline{j}$}
    ...
    \If {$\tau = \arraytype{\tau'}{n}$}
        \State $o \gets o + \convert{\indextype}{j_1} \cdot \valoftype{|\tau'|}{\indextype}$ \label{line:array-index}
...
\Function{eval-gep}{$\tau, p, \overline{j}$}
    ...
    \State $o \gets \convert{\indextype}{j_0} \cdot \valoftype{|\tau|}{\indextype}$ \label{line:first-index}
