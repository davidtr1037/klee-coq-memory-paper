...
Now, we define the major components of the memory model:
...
First, modeling such memory allocators requires developing a more complex theory of memory (\Cref{sec:core}).
