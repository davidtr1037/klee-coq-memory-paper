...
that were used in the past in the context of \SE~\cite{klee,symsize-model,compact-s-e,klee-rocq}.
...
\begin{figure*}
    ...
    \end{subfigure}
    \caption{The proof time (left) and proof size (right) in each program.}
    \label{figure:proof-results}
\end{figure*}

In this experiment,
we run each program using the \proofopt and \base modes in order to evaluate the validity and effectiveness of our approach,
...
\textbf{\text{RQ3.}}
\Cref{figure:proof-results} shows the proof time and the proof size for each program.
