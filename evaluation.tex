...
since our approach currently does not model the environment (command-line arguments, file system, networking, \etc).
%Our implementation supports memory operations,
%so our goal is to evaluate it on memory-manipulating programs.
For this, we selected several benchmarks that were used in the past in the context of \SE~\cite{klee,symsize-model,compact-s-e,pinaka,klee-rocq}:
