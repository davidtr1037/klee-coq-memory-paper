...
so we selected memory-manipulating programs that do not invoke external calls,
since our approach currently does not model the environment (command-line arguments, file system, \etc).
%Our implementation supports memory operations,
...
A detailed breakdown is given in the appendix (Appendix A.1).
}
...
A detailed breakdown of the results for each subject is given in the appendix (Appendix A.2).
}
