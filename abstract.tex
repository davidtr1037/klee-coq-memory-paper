...
% two parts: formalization / instrumentation
Our implementation consists of a \coq formalization of a subset of \llvm with memory instructions and an extension of \klee that generates safety proofs based in this formalization.
%Our implementation is built on top of \klee and supports a subset of \llvm with memory instructions and generates proofs in \coq.
