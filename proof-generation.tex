...
\symstate
    {...}
    {\{ ..., \nameid{arrayidx} \mapsto \bvadd_{64}(\addr_0, \bvzext_{64}(\bvmul_{32}(\bvextract_{32}(0), 1))) \}}
    {[]}
    {...}
    {n < 2}
\]
...
\]
where:
\[ \smtarray \triangleq \arraystore{\arraystore{\arrayconst{\arrayinitvalue}}{0}{7}}{1}{\arrayinitvalue} \]
The derived symbolic state:
\[
\symstate
    {...}
