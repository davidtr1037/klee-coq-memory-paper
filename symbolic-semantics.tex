...
Note that this rule might have multiple derivations, since $p$ may be concretized to different base addresses.
...
This procedure reads the corresponding sequence of stored SMT expressions (of sort $\bvsort{8}$),
and then translated them to a \textit{concat} expression.
% TODO: example?
...
This procedure serializes the expression $e$ into a sequence of SMT expressions (of sort $\bvsort{8}$)
