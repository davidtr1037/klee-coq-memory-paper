...
\Function{compute-offset}{$\tau, o, \overline{j}$}
    ...
    \If {$\tau = \arraytype{\tau'}$}
        \State $o \gets \bvadd_{32}(o, \bvmul_{32}(\bvsext_{32}(j_1), \bvconst_{32}(|\tau'|)))$ \label{line:array-index}
...
\Function{compute-pointer}{$\tau, p, j_0, \overline{j}$}
    \State $o \gets \bvmul_{32}(\bvsext_{32}(j_0), \bvconst_{32}(|\tau|))$ \label{line:first-index}
