...
\[ \moSymReadFunc : \SymMemoryObjects \times \smtsort{\pointerwidth} \times \Types \to ??? \]
The $\moSymReadFunc$ function receives a memory object $\symmo$, a pointer $p$, and a type $\tau$.
...
\[ \moSymWriteFunc : \SymMemoryObjects \times \pointertype \times ??? \to \SymMemoryObjects \]
The $\moSymWriteFunc$ function receives a memory object $\symmo$ (\ie $\mobj{\addr}{\size}{\smtarray}$), a pointer $p$, and an SMT expression $e$.
