...
% TODO: improve / define s and c
% TODO: the main usage is not for error states
Informally,
...
In the following, we extend the definition given in~\cite{klee-rocq} (Definition 3.4) to account for memory.
