...
\definecolor{codecolor}{RGB}{122,122,122}
...
\newcommand\valoftype[2]{{#1}_{#2}}
\newcommand\bvsort[1]{\textsf{i}{\textsf{#1}}}
\newcommand\bvval[2]{\textcolor{bvcolor}{\valoftype{#1}{\bvsort{#2}}}}
...
%\newcommand{\isbaseaddr}[2]{\mathit{is\_base\_addr}(#1, #2)}
...
\newcommand{\evalgep}{\mathit{eval\_gep}}

% SMT
\definecolor{smtcolor}{RGB}{33, 70, 158}
...
%\newcommand{\symisbaseaddr}[3]{\mathit{is\_base\_addr}(#1, #2, #3)}
