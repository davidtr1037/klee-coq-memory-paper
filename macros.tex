...
\newcommand\tmalloc{\opcode{malloc}}
\newcommand\tfree{\opcode{free}}
...
\newcommand{\addr}{a}
\newcommand{\size}{s}
\newcommand{\arrayvalue}{\mathit{arr}}
...
\newcommand{\invalidaccess}{\mathit{invalid\_access}}
...
\newcommand{\smtarray}{\widetilde{arr}}
...
\newcommand{\libtasn}{\textit{libasn1}\xspace}
