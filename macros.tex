...
\newcommand{\moSymReadFunc}{\mathit{read}}
\newcommand{\moSymRead}[3]{\moSymReadFunc(#1,#2,#3)}
\newcommand{\moSymWriteFunc}{\mathit{write}}
\newcommand{\moSymWrite}[3]{\moSymWriteFunc(#1,#2,#3)}
