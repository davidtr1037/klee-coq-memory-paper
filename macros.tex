...
% general purpose
\newcommand\moreadfunc{\mathit{read}}
\newcommand\moread[3]{\moreadfunc(#1,#2,#3)}
\newcommand\mowritefunc{\mathit{write}}
\newcommand\mowrite[3]{\mowritefunc(#1,#2,#3)}
\newcommand\heapreplace[3]{#1[#3/#2]}
\newcommand\heapwrite[4]{\heapreplace{#1}{#2}{\mowrite{#2}{#3}{#4}}}
...
\newcommand{\symmoreadfunc}{\widetilde{\mathit{read}}}
\newcommand{\symmoread}[3]{\symmoreadfunc(#1,#2,#3)}
\newcommand{\symmowritefunc}{\widetilde{\mathit{write}}}
\newcommand{\symmowrite}[3]{\symmowritefunc(#1,#2,#3)}
\newcommand{\symheapreplace}[3]{#1[#3/#2]}
\newcommand{\symheapwrite}[4]{\symheapreplace{#1}{#2}{\symmowrite{#2}{#3}{#4}}}
