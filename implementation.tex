...
In the $\tgep$ instruction, our implementation currently supports the \opcode{nuw} attribute.

\subsection{\coq Framework}
Our \coq framework consists of approximately 40,000 lines of code (LOC),
excluding third-party dependencies (\eg CompCert~\cite{CompCert}).
For comparison,
this is more than twice the size of the framework of~\cite{klee-rocq}, which consists of approximately 18,000 LOC.
%This substantial extension reflects the additional complexity of our framework.
...
To provide a detailed insight into our framework,
we report the size (LOC) of its core components:
...
Appendix B provides additional details on the mapping between the various definitions introduced in this paper and their corresponding formalizations in \coq.
%\begin{itemize}
