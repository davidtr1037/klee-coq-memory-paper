...
Our \coq formalization consists of approximately 40,000 lines of code (LOC), excluding third-party dependencis (\eg CompCert integers).
For comparison,
...
this is one of the largest \coq mechanizations in programming language (...).
% main theorem: 3.5K
% completeness: 6.2K
...
\begin{itemize}
    ...
    \item Simplification theory: (\Cref{theorem:safety-via-et}): $\approx$8,100 LOC
