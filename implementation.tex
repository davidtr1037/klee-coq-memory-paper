...
this is one of the largest \coq formalizations in programming language theory (\eg CompCert~\cite{CompCert}, VST~\cite{vst}, Iris~\cite{irisproject}, and $CH_2O$~\cite{krebbers2015typed}).
% main theorem: 3.5K
% completeness: 6.2K
...
\paragraph{Issue 1: Inconsistent Modeling of the Index Type}
On one hand,
...
\paragraph{Issue 2: Incorrect Interpretation of \textup{$\tgep$}}
...
\paragraph{Issue 3: Incorrect Interpretation of Memory Allocations}
...
\paragraph{Issue 4: Silent Truncation in Memory Allocations}
