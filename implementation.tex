...
Our formalization is based on~\cite{klee-rocq},
...
Our \coq formalization consists of approximately 40,000 lines of code (LOC), excluding third-party dependencis (\eg CompCert~\cite{CompCert} integers).
For comparison,
this is more than twice the size of the formalization of~\cite{klee-rocq}, which consists of approximately 18,000 LOC.
...
To provide a detailed insight into the core components of our formalization,
