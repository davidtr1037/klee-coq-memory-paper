...
\subsubsection{\textit{Inconsistent modeling of the index type.}}
On one side,
\klee uses an SMT array of sort $\arraysort{\smtsort{32}}{\smtsort{8}}$ to represent the contents of memory objects,
...
\subsubsection{\textit{Memory Allocation.}}
